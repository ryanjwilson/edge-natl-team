...
//       const wrapper = mount(<TournamentEditor browserHistory={browserHistory} call={call} selectedTournamentId={sampleTournaments[0]._id}/>);
//       expect(wrapper.find('p').text()).toBe('Tournament not found.');
//     });
//
//     // it('should remove a tournament', function() {
//     //   const wrapper = mount(<TournamentEditor browserHistory={browserHistory} call={call} selectedTournamentId={sampleTournaments[0]._id} tournament={sampleTournaments[0]}/>);
//     //   wrapper.find('#delete-button').simulate('click');
//     //   expect(call).toHaveBeenCalledWith('sampleTournaments.remove', sampleTournaments[0]._id);
...
//     //   expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { published: !sampleTournaments[0].published });
//     // });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { name });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { location });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { startDate });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { endDate });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { weighins });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { alternateWeighins });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { division });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { weightClasses });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { allowance });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { year });
//     });
//
...
//       expect(call).toHaveBeenCalledWith('sampleTournaments.update', sampleTournaments[0]._id, { season });
//     });
//
...
//
//       wrapper.setProps({
//         selectedTournamentId: sampleTournaments[0]._id,
//         tournament: sampleTournaments[0]
//       });
//
//       expect(wrapper.state('name')).toBe(sampleTournaments[0].name);
//       expect(wrapper.state('location')).toBe(sampleTournaments[0].location);
//       expect(wrapper.state('date')).toBe(sampleTournaments[0].date);
//       expect(wrapper.state('weighins')).toBe(sampleTournaments[0].weighins);
//       expect(wrapper.state('alternateWeighins')).toBe(sampleTournaments[0].alternateWeighins);
//       expect(wrapper.state('weightClasses')).toBe(sampleTournaments[0].weightClasses);
//       expect(wrapper.state('allowance')).toBe(sampleTournaments[0].allowance);
//       expect(wrapper.state('year')).toBe(sampleTournaments[0].year);
//       expect(wrapper.state('season')).toBe(sampleTournaments[0].season);
//       expect(wrapper.state('published')).toBe(sampleTournaments[0].published);
//     });
//
